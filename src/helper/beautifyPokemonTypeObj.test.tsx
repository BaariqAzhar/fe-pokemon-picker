import beautifyPokemonTypeObj from './beautifyPokemonTypeObj'

describe('helper/function beautifyPokemonTypeObj', () => {

    const unstructuredPokemon = {
        "abilities": [
            {
                "ability": {
                    "name": "torrent",
    ...
    test('convert to structured object', () => {
        expect(beautifyPokemonTypeObj(unstructuredPokemon)).toStrictEqual(structuredPokemon)
    })
