    ...
    return (
        <>
            ...
            <div style={{ marginTop: 32 }}>
                <Typography.Text>
                    Hi Pokemon trainer! Welcome to the world of Pokemon! Get ready to explore a variety of Pokemon, and catch them. Be the best and
                    achieve the glory of becoming a Pokemon Master!
                </Typography.Text>
            </div>
        </>
    );
...
const PageGoDetail = () => {
    return (
        <>
            <Typography.Text style={{ fontSize: 18 }}>View detail of pokemon</Typography.Text>
            <br />
            <br />
            <Row justify="center">
                <Col>
            ...
            <br />
            <br />
            <Typography.Text>In Home page &#8220;/&#8221;, click &#8220;Detail&#8221;</Typography.Text>
            <br />
            <br />
            <Row justify="center">
                <Col>
...
const PageCatch = () => {
    return (
        <>
            <Typography.Text style={{ fontSize: 18 }}>Catch pokemon</Typography.Text>
            <br />
            <br />
            <Row justify="center">
                <Col>
            ...
            <Typography.Text>In Detail page &#8220;/detail/?id&#8221;, click &#8220;Catch the pokemon&#8221;</Typography.Text>
            <br />
            <br />
            <Row justify="center">
                <Col>
            ...
            <Typography.Text>Pokeball icon has change from monochrome to red-white</Typography.Text>
        </>
    );
};
...
const PageAvatar = () => {
    return (
        <>
            <Typography.Text style={{ fontSize: 18 }}>Select your avatar</Typography.Text>
            <br />
            <br />
            <Row justify="center">
                <Col>
            ...
            <Typography.Text>Click edit icon and it will show form select avatar</Typography.Text>
        </>
    );
};
...
const TutorialsModal = ({ showTutorials, handleShowTutorials }: TutorialsModalProps) => {
    ...
    return (
        <Modal title="Tutorials" open={showTutorials} onCancel={handleShowTutorials} footer={null}>
